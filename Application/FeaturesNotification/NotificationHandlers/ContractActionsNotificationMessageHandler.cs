...
{
    public class ContractActionsNotificationMessageHandler : INotificationHandler<NotificationMessage>
    {
        ...
        public ContractActionsNotificationMessageHandler(IApplicationDbContext applicationDbContext, IMediator mediator, RoleManager<Group> roleManager, IOptionsSnapshot<AssetURLS> assetURLS, UserManager<User> userManager)
        {
        ...
        public async Task Handle(NotificationMessage notification, CancellationToken cancellationToken)
        {
            ...
            //if (notification.NotificationActionType == NotificationActionType.ContractCreated)
            //{
            //    bool generated = await generateEmail.ContractCreated(notification);
            //}
        }
    }
}