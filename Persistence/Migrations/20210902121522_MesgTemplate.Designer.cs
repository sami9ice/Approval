...
namespace Persistence.Migrations
{
    ...
    [Migration("20210902121522_MesgTemplate")]
    partial class MesgTemplate
    {
            ...
            modelBuilder.Entity("Domain.Entities.MailConfigurations", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2021, 9, 2, 12, 15, 21, 327, DateTimeKind.Utc).AddTicks(3153),
                            DateDeleted = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            DateModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2021, 9, 2, 12, 15, 21, 327, DateTimeKind.Utc).AddTicks(5247),
                            DateDeleted = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            DateModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            From = "Account@cyberspace.net.ng",
                            FromName = "Marketer",
            ...
            modelBuilder.Entity("Domain.User.Group", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "2380b2a7-5350-4cd4-8a31-7e83a98ac5ce",
                            CreatedBy = "System",
                            DateCreated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateDeleted = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            DateModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            GroupEmail = "Account@gmail.com",
                            GroupId = "46543f48-2305-48df-a8f3-b8278b1ffbb4",
            ...
            modelBuilder.Entity("Domain.User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ComfirmPin = false,
                            ConcurrencyStamp = "cbb99797-1305-4de1-a777-bb4a90729059",
                            CreatedBy = "System",
                            DateCreated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateDeleted = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            DateModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            SecurityStamp = "c7315eb4-a915-464d-b740-5b7e4c7e821b",
                            Signature = (byte)0,
