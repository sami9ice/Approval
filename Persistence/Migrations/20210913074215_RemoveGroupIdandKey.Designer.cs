...
namespace Persistence.Migrations
{
    ...
    [Migration("20210913074215_RemoveGroupIdandKey")]
    partial class RemoveGroupIdandKey
    {
            ...
            modelBuilder.Entity("Domain.Entities.MailConfigurations", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2021, 9, 13, 7, 42, 14, 64, DateTimeKind.Utc).AddTicks(913),
                            DateDeleted = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            DateModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2021, 9, 13, 7, 42, 14, 64, DateTimeKind.Utc).AddTicks(3247),
                            DateDeleted = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            DateModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            From = "Account@cyberspace.net.ng",
                            FromName = "Marketer",
            ...
            modelBuilder.Entity("Domain.User.Group", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "c42d2293-cb52-410b-b86d-ec72cf06d848",
                            CreatedBy = "System",
                            DateCreated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateDeleted = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            DateModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("Domain.User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ComfirmPin = false,
                            ConcurrencyStamp = "2b64bc7f-2fc0-4c21-b1a7-508d9d35f086",
                            CreatedBy = "System",
                            DateCreated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateDeleted = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            DateModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            SecurityStamp = "54206a6c-4d3e-4250-bbb8-40dbb9333f63",
