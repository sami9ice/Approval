...
namespace Persistence.Migrations
{
    ...
    [Migration("20210915145537_ChangeGroupLevelAndDataGroupRelationship")]
    partial class ChangeGroupLevelAndDataGroupRelationship
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.MailConfigurations", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2021, 9, 15, 14, 55, 35, 565, DateTimeKind.Utc).AddTicks(4462),
                            DateDeleted = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            DateModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2021, 9, 15, 14, 55, 35, 565, DateTimeKind.Utc).AddTicks(7688),
                            DateDeleted = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            DateModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            From = "Account@cyberspace.net.ng",
                            FromName = "Marketer",
            ...
            modelBuilder.Entity("Domain.User.Group", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "25289f66-9451-4870-bdd9-381208ba65d8",
                            CreatedBy = "System",
                            DateCreated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateDeleted = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            DateModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("Domain.User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ComfirmPin = false,
                            ConcurrencyStamp = "bcbe7266-2f2b-43ee-a5c9-6795db8a57c8",
                            CreatedBy = "System",
                            DateCreated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateDeleted = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            DateModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            SecurityStamp = "9bbb1a77-951b-449d-bd02-bea64bfe4d8f",
            ...
            modelBuilder.Entity("Domain.User.User", b =>
                {
                    b.HasOne("Domain.User.Group", "Groups")
                        .WithOne("User")
                        .HasForeignKey("Domain.User.User", "GroupId");
