...
namespace Persistence.Migrations
{
    ...
    [Migration("20210909000652_RemoveEmailAddressFromUsertable")]
    partial class RemoveEmailAddressFromUsertable
    {
            ...
            modelBuilder.Entity("Domain.Entities.MailConfigurations", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2021, 9, 9, 0, 6, 50, 595, DateTimeKind.Utc).AddTicks(9715),
                            DateDeleted = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            DateModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2021, 9, 9, 0, 6, 50, 596, DateTimeKind.Utc).AddTicks(4813),
                            DateDeleted = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            DateModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            From = "Account@cyberspace.net.ng",
                            FromName = "Marketer",
            ...
            modelBuilder.Entity("Domain.User.Group", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "502ea4f0-4306-44a3-9e60-b970c8b7b0ec",
                            CreatedBy = "System",
                            DateCreated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateDeleted = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            DateModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            GroupEmail = "Account@gmail.com",
                            GroupId = "95f40909-e16e-4494-9a91-09f786a7f06c",
            ...
            modelBuilder.Entity("Domain.User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ComfirmPin = false,
                            ConcurrencyStamp = "d9fc60a7-6945-471e-a423-6797a0c96376",
                            CreatedBy = "System",
                            DateCreated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateDeleted = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            DateModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            SecurityStamp = "d285bbb6-ee7e-49f1-97bb-03b45be2894f",
