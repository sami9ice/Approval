...
namespace Persistence.Migrations
{
    ...
    [Migration("20210831125310_userWithGroupcollection")]
    partial class userWithGroupcollection
    {
            ...
            modelBuilder.Entity("Domain.Entities.MailConfigurations", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2021, 8, 31, 12, 53, 8, 500, DateTimeKind.Utc).AddTicks(3123),
                            DateDeleted = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            DateModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2021, 8, 31, 12, 53, 8, 501, DateTimeKind.Utc).AddTicks(7155),
                            DateDeleted = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            DateModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            From = "Account@cyberspace.net.ng",
                            FromName = "Marketer",
            ...
            modelBuilder.Entity("Domain.User.Group", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "7936fdbd-5201-4dbc-9e27-70e511f7a36d",
                            CreatedBy = "System",
                            DateCreated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateDeleted = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            DateModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            GroupEmail = "Account@gmail.com",
                            GroupId = "1db470fa-e184-43b9-9e6c-6fee4dce651e",
            ...
            modelBuilder.Entity("Domain.User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ComfirmPin = false,
                            ConcurrencyStamp = "416ecfa1-a739-46ad-befa-d00b6b789367",
                            CreatedBy = "System",
                            DateCreated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateDeleted = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            DateModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            SecurityStamp = "e8e58fff-47ec-441c-939c-5f112fa67e87",
                            Signature = (byte)0,
